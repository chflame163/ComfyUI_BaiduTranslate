...
用文本编辑软件打开BaiduTranslate.py，在44和45行的引号内分别填入你的APIid和密钥，保存文件。重启ComfyUI生效。  
...
- 如需预览文本，可后面接一个“Preview Text Node”（需先安装 [ComfyUI_Custom_Nodes_AlekPet](https://github.com/AlekPet/ComfyUI_Custom_Nodes_AlekPet)）  
